...
def _build_system_prompt(payload: dict) -> str:
    ...
    parts.append(
        ...
        "- GOALS vs REMINDERS: When the user shares something they want to ACHIEVE (not just be reminded about), "
        "use create_goal instead of create_reminder. Goal signals: 'I need to...', 'I want to...', "
        "'My target is...', deadlines with multi-step effort, measurable outcomes. Examples:\n"
        "  - 'I need to publish 3 LinkedIn posts by end of week' → create_goal (multi-step, needs planning)\n"
        "  - 'Remind me to call mom at 5pm' → create_reminder (single action, specific time)\n"
        "  - 'I want to lose 10 pounds by summer' → create_goal (long-term, needs coaching)\n"
